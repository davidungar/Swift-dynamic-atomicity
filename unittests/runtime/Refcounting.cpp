...
static const FullMetadata<ClassMetadata> TestClassObjectMetadata = {
  { { &destroyTestObject, MakeContainedReferencesCountAtomicallyValues::unimplemented /*dmu makeContainedReferencesCountAtomicallyLayoutContents*/ }, { &VALUE_WITNESS_SYM(Bo) } },
