...
NO_RESULT_OWNERSHIP_INST(StoreBarrier_dmu_)
...
NO_RESULT_OWNERSHIP_INST(VisitRefAtAddr_dmu_)
...
CONSTANT_OWNERSHIP_BUILTIN(Trivial, VisitRefsInArray_dmu_)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, VisitRefs_dmu_)
