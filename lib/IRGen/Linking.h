...
public:
  ...
  static LinkEntity forSILGlobalVariable_ThreadID_dmu_(SILGlobalVariable *G) {
    LinkEntity entity;
    entity.Pointer = G;
    entity.SecondaryPointer = nullptr;
    entity.Data = LINKENTITY_SET_FIELD(Kind, unsigned(Kind::SILGlobalVariable_ThreadID_dmu_));
    return entity;
  }
