...
//  };
  ...
  public:
    ...
    void addMakeContainedReferencesCountAtomicallyFunction() { // dmu makeContainedReferencesCountAtomicallyCreation
      // dmu entry into makeContainedReferencesOfElementCountAtomically
      llvm::Constant *makeContainedReferencesAtomicallyFn =
        createMakeContainedReferencesCountAtomicallyFn();
      addWord(makeContainedReferencesAtomicallyFn);
    }
