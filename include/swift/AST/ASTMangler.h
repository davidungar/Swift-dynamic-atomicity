...
public:
  ...
  std::string mangleVisitRefsInInstance_dmu_Entity(const VisitRefsInInstance_dmu_Decl *decl,
                                     SymbolKind SKind);
...
protected:
  ...
  void appendVisitRefsInInstance_dmu_Entity(const VisitRefsInInstance_dmu_Decl *decl);
